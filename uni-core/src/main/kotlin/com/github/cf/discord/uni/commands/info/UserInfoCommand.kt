...
import com.github.cf.discord.uni.extensions.findUsers
import com.github.cf.discord.uni.extensions.findMembers
import com.github.cf.discord.uni.extensions.noMatch
import com.github.cf.discord.uni.extensions.multipleUsers
import com.github.cf.discord.uni.extensions.multipleMembers
...
class UserInfoCommand {
    ...
    fun userInfoCommand(context: CommandContext, event: MessageReceivedEvent): MessageAction? {
        ...
        val embed = EmbedBuilder()
                ...
                .addField("Highest role: ", "${member.roles!!.sortedBy { it.position }.last()?.name
                        ?: "None"}\n", true)
                ...
                .addField("Avatar Url: ", "[Avatar]( ${member.user!!.avatarUrl
                        ?: "https://maxcdn.icons8.com/Share/icon/Logos/discord_logo1600.png"} )", true)
